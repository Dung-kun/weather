...
import 'package:weatherproject/service/TempConvertService.dart';
  ...
  Widget _mapWeatherConditionToImage(WeatherCondition condition) {
    ...
    switch (condition) {
      case WeatherCondition.thunderstorm:
        image = Image.asset('assets/images/thunder_storm.png', width: 30, height: 30);
        break;
      case WeatherCondition.heavyCloud:
        image = Image.asset('assets/images/cloudy.png', width: 30, height: 30);
        break;
      case WeatherCondition.lightCloud:
        image = Image.asset('assets/images/light_cloud.png', width: 30, height: 30);
        break;
      ...
      case WeatherCondition.atmosphere:
        image = Image.asset('assets/images/atmosphere.png', width: 30, height: 30);
        break;
