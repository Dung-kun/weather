  ...
  Widget _mapWeatherConditionToImage(
    ...
    switch (condition) {
      case WeatherCondition.thunderstorm:
        image = Image.asset('assets/images/thunder_storm.png', width: 50, height: 50,);
        break;
      ...
      case WeatherCondition.lightCloud:
        isDayTime
            ? image = Image.asset('assets/images/light_cloud.png', width: 50, height: 50)
            : image = Image.asset('assets/images/light_cloud-night.png', width: 50, height: 50);
        break;
      ...
      case WeatherCondition.clear:
        isDayTime
            ? image = Image.asset('assets/images/clear.png', width: 50, height: 50)
            : image = Image.asset('assets/images/clear-night.png', width: 50, height: 50);
        break;
